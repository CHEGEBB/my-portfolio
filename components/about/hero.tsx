...
// ─── Pure 2D canvas sphere — no WebGL, navigation-safe ───────────────────────
...
export function AboutHero() {
  ...
  // GSAP entrance — identical pattern to ProcessHero, no DOM mutation
  useEffect(() => {
      ...
      <div style={{ position: "relative", zIndex: 5, padding: "0 clamp(1.5rem,6vw,5rem) clamp(3rem,6vw,5rem)" }}>
        ...
        <h1
          ...
          style={{
            ...
            fontWeight: 800, letterSpacing: "-.05em", lineHeight: 0.9,
...
// Self-contained scroll indicator — zero keyframes, pure state toggle
