...
export function AboutStory() {
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      // Nothing fades — everything scrolls naturally with the track
    }, sectionRef)

    return () => { ctx.revert(); revealed.clear() }
  }, [])

  // Active chapter index for dot indicator
  ...
  return (
    ...
    >
      ...
      {/* ── SCROLL INDICATOR PILL (bottom-right, fixed) ── */}
      <div style={{
        position:"absolute",
      ...
      <div ref={trackRef} style={{ display:"flex", alignItems:"stretch", height:"100%", willChange:"transform" }}>
        ...
        <div className="story-intro-panel" style={{
          ...
          <div className="story-intro-text" style={{ position:"relative", zIndex:2, flex:"0 0 auto", maxWidth:"clamp(260px,38vw,480px)" }}>
            ...
            {/* Scroll hint */}
            <div className="intro-hint" style={{
          ...
          <div className="intro-img-wrap" style={{
            ...
            {/* Asymmetric diamond-ish clip — not a boring rectangle */}
            <div style={{
            ...
            {/* Floating year stamp over image */}
            <div style={{
      ...
      <style>{`
        ...
        /* Mobile: stack text on top, image below — both full width */
