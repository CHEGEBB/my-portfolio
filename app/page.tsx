...
export default function HomePage() {
  ...
  const techStack = [
    ...
    },
    {
      name: "MongoDB",
      icon: mongodbIcon,
      glowColor: "group-hover:shadow-green-400/30",
    },
    {
      name: "PostgreSQL",
      icon: postgresqlIcon,
    ...
    },
    {
      name: "AWS",
      icon: awsIcon,
      glowColor: "group-hover:shadow-orange-400/30",
    },
    {
      name: "GraphQL",
      icon: graphqlIcon,
      glowColor: "group-hover:shadow-pink-400/30",
    },
    {
      name: "Figma",
      icon: figmaIcon,
    ...
    },
    {
      name: "Flutter",
      icon: flutterIcon,
      glowColor: "group-hover:shadow-blue-300/30",
    },
  ];
  ...
  const featuredProjects = [
    ...
    },
    {
      ...
      description:
        "Secure, transparent voting platform built on blockchain technology with end-to-end encryption",
      image:
    ...
    },
    {
      ...
      description:
        "Multi-user collaborative workspace with real-time editing, video calls, and project management",
      image:
          ...
          >
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              >
                ...
                >
                  <span className="text-gradient-emerald gentle-glow">
                    DIGITAL
                  </span>
                  <br />
                  <span className="text-gradient-emerald gentle-glow">
      ...
      <section className="relative py-32 px-4 z-10">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="mt-16 flex justify-center space-x-8 opacity-30">
            ...
            <div className="text-cyan-400 font-mono text-xs animate-pulse delay-500">
              [ STACK LOADED ]
            </div>
            <div className="text-emerald-300 font-mono text-xs animate-pulse delay-1000">
              [ INNOVATION MODE ]
            </div>
          </div>
        </div>
      ...
      <section className="relative py-32 px-4 z-10 overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto relative z-10">
          ...
          >
            ...
            <div
              className="inline-block bg-slate-900/80 backdrop-blur border border-emerald-400/30 p-4 mb-8 font-mono"
              style={{
                clipPath:
            ...
            <p className="text-lg text-emerald-300/80 font-mono max-w-3xl mx-auto">
              <span className="text-emerald-500">[INFO]</span> Real-time
              performance indicators from the digital realm
          ...
          <div className="grid md:grid-cols-4 gap-8">
            {[
              ...
              >
                ...
                <div
                  className="relative bg-slate-900/90 backdrop-blur-md border border-emerald-400/20 group-hover:border-emerald-400/60 transition-all duration-500 overflow-hidden transform-gpu"
                  style={{
                    clipPath:
                      "polygon(0 15px, calc(100% - 15px) 0, 100% calc(100% - 15px), 15px 100%)",
                  }}
                >
                  {/* Scanning line effect */}
                  ...
                  <div className="p-8 text-center relative">
                    ...
                    <div className="relative mb-6">
                      <stat.icon
                        className={`w-16 h-16 ${stat.color} mx-auto transition-all duration-300 group-hover:scale-110`}
                      />
                      <div className="absolute inset-0 flex items-center justify-center">
                        <div
                          className={`w-16 h-16 ${stat.color} opacity-0 group-hover:opacity-20 transition-opacity duration-300`}
                          style={{
                            filter: "blur(8px)",
                    ...
                    <div className="font-mono mb-4">
                      ...
                      <div
                        className={`text-4xl font-black ${stat.color} mb-2 transition-all duration-300 group-hover:scale-110`}
                        style={{
          ...
          >
            <div
              className="inline-block bg-slate-900/80 backdrop-blur border border-emerald-400/30 px-6 py-3 font-mono text-sm"
              style={{
                clipPath:
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          >
            ...
            <p className="text-lg text-emerald-300/80 font-mono max-w-3xl mx-auto relative">
              <span className="text-emerald-500">&gt;</span> Executing advanced
              digital solutions...
            ...
            {featuredProjects.map((project, index) => (
              ...
              >
                ...
                <div className="relative transform-gpu">
                  ...
                  <div
                    className="relative bg-slate-900/90 backdrop-blur-sm border border-emerald-400/30 group-hover:border-emerald-400/70 transition-all duration-500 overflow-hidden"
                    style={{
                      clipPath:
                        "polygon(0 10px, calc(100% - 10px) 0, 100% calc(100% - 10px), 10px 100%)",
                    }}
                  >
                    {/* Scan line effect */}
                    <div className="absolute top-0 left-0 w-full h-0.5 bg-gradient-to-r from-transparent via-emerald-400 to-transparent opacity-0 group-hover:opacity-100 group-hover:animate-pulse" />
          ...
          >
            <div
              className="inline-block bg-slate-900/90 backdrop-blur border border-emerald-400/30 p-6 font-mono"
              style={{
                clipPath:
            ...
            >
              ...
              <div className="text-emerald-400/60 text-xs mt-2">
      ...
      <section className="relative py-32 px-4 z-10 overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto relative z-10">
          ...
          >
            {/* Terminal-style header */}
            <div
              className="inline-block bg-slate-900/80 backdrop-blur border border-emerald-400/40 p-6 mb-8 font-mono relative"
              style={{
                clipPath:
                  "polygon(20px 0, 100% 0, calc(100% - 20px) 100%, 0 100%)",
              }}
            >
              ...
              <div className="text-emerald-400 text-sm mb-2">
                $ ./initialize_quick_access --mode=hacker
              </div>
            ...
            <p className="text-lg text-emerald-300/80 font-mono max-w-3xl mx-auto">
              <span className="text-emerald-500">[SYSTEM]</span> Direct pathways
              to different dimensions of my digital universe
              <span className="inline-block w-2 h-5 bg-emerald-400 ml-1 animate-pulse" />
            </p>
          </motion.div>
            ...
            {[
              {
                ...
                description:
                  "Direct command-line interface to my development environment",
                icon: Terminal,
                href: "/playground",
              ...
              },
              {
                ...
                description:
                  "Explore my thought processes and development journey",
                icon: Brain,
                href: "/about",
                color: "from-purple-500 to-pink-600",
                code: "MIND_003",
              ...
              >
                ...
                <div
                  className="relative bg-slate-900/90 backdrop-blur-sm border border-emerald-400/30 group-hover:border-emerald-400/80 transition-all duration-500 overflow-hidden transform-gpu h-full"
                  style={{
                    clipPath:
                      "polygon(0 20px, calc(100% - 20px) 0, 100% calc(100% - 20px), 20px 100%)",
                  }}
                >
                  ...
                  >
                    ...
                    <div className="relative mb-6 flex-shrink-0">
                      ...
                      >
                        ...
                        {/* Rotating border */}
                        <div
                          className="absolute inset-0 border-2 border-white/30 rounded-2xl opacity-0 group-hover/link:opacity-100 group-hover/link:rotate-180 transition-all duration-700"
                          style={{
                            clipPath:
                              "polygon(15% 0%, 85% 0%, 100% 15%, 100% 85%, 85% 100%, 15% 100%, 0% 85%, 0% 15%)",
                          }}
          ...
          >
            <div
              className="inline-block bg-slate-900/90 backdrop-blur border border-emerald-400/40 px-8 py-4 font-mono"
              style={{
                clipPath:
                  "polygon(15px 0, 100% 0, calc(100% - 15px) 100%, 0 100%)",
              }}
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              },
              {
                ...
                hoverGradient:
                  "hover:from-slate-500/30 hover:to-emerald-600/30",
          ...
          `}
              ...
              `}
                ...
                group-hover:bg-gradient-to-r ${
                  service.iconColor === "text-blue-400"
                    ? "group-hover:from-blue-400 group-hover:to-slate-300"
                    : service.iconColor === "text-slate-400"
                    ? "group-hover:from-slate-400 group-hover:to-emerald-400"
                    ...
                    <ul className="space-y-3">
                      {service.features.map((feature, featureIndex) => (
                        ...
                        >
                          <div
                            className={`
                      w-2 h-2 ${service.iconColor.replace(
                        "text-",
                        "bg-"
                      )} rounded-full 
                      ...
                      ${
                        service.iconColor === "text-blue-400"
                          ...
                          : service.iconColor === "text-slate-400"
                          ? "group-hover:shadow-slate-400/50"
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid md:grid-cols-4 gap-8 mb-12">
            ...
            <div className="md:col-span-2">
              <div className="flex items-center space-x-4 mb-4">
                ...
                <div>
                  <div className="text-xl font-bold text-gradient-emerald font-mono">
                    CHEGEBB
                  </div>
              ...
              <p className="text-slate-300 text-sm leading-relaxed max-w-md">
                ...
                imagination and reality. Specializing in full-stack development,
                AI integration, and immersive web technologies.
              </p>
            </div>

            {/* Quick Links */}
            <div>
              <h4 className="text-lg font-bold text-emerald-400 mb-4 font-mono">
                Navigation
              </h4>
          ...
          <div className="pt-8 border-t border-emerald-400/20 flex flex-col md:flex-row justify-between items-center">
            <div className="text-slate-400 text-sm font-mono">
              © 2024 Brian Chege (CHEGEBB). All rights reserved.
            </div>
