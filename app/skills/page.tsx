    ...
    () => [
      {
        ...
        image: "/assets/sw.png",
        description:
          "12-month comprehensive software engineering program. Specialized focus on back-end development.Industry-level training and certification ",
        skills: ["React", "Node.js", "Mongodb", "Puppet","Flask"],
      },
      {
        name: "Prodigy InfoTech - Full-Stack Web Development Internship",
        issuer: "Prodigy Infotech",
        year: "2024",
        icon: <Hexagon className="w-8 h-8 text-blue-400" />,
        image: "/assets/pro.png",
        description:
          "1-month intensive program with outstanding performance in complete full-stack development.",
        skills: ["Mongodb", "ExpressJS", "React", "NodeJS"],
      },
      {
        name: "CodSoft - Web Development Virtual Internship",
        issuer: "Codsoft",
        year: "2024",
        icon: <Server className="w-8 h-8 text-green-500" />,
        image: "/assets/cod.png",
        description:
          "4-week intensive program with exceptional performance in practical web development and real projects.",
        skills: ["Express", "Async/Await", "React", "Mongodb"],
      },
      {
        name: "ALX Ventures Founder Academy (June 30, 2024)",
        issuer: "Alx",
        year: "2024",
        icon: <Database className="w-8 h-8 text-green-400" />,
        image: "/assets/founder.png",
        description:
          "Entrepreneurship and business foundation program powered by ALX and Mastercard Foundation",
        skills: ["React native"],
      },
      {
        name: "Cisco Networking Academy - JavaScript Essentials",
        issuer: "Cisco.",
        year: "2024",
        icon: <Database className="w-8 h-8 text-green-400" />,
        image: "/assets/javascript.png",
        description:
          "Comprehensive JavaScript programming fundamentals including data types, variables, operators, flow control, algorithmic thinking, and error handling",
        skills: ["Javascript"],
      },
      {
        ...
        year: "2024",
        icon: <Database className="w-8 h-8 text-green-400" />,
        image: "/assets/ciscocyber.png",
        description:
          "Covers fundamentals of online safety, cyber threats, attacks, vulnerabilities, organization protection strategies, and cybersecurity career exploration",
        skills: ["Cybersecurity","Threat intelligence"],
      },
    ],
    [],
  )
